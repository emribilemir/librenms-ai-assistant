...
export default function App({ chatStore = defaultStore, identity = defaultIdentity, api = apiClient }) {
  ...
  const activeRunsRef = useRef(new Map()); const demoActiveRef = useRef(false); const deleteTriggerRef = useRef(null); const mainRef = useRef(null); const token = identity?.token || "";
